                    ...
                    <div class="column is-6-desktop is=8">
                        <div class="card">
                            ...
                            <footer class="card-footer">
                                ...
                                <p class="card-footer-item">
                                    <span>
                                        <?= $this->Html->link(__('配送完了'),'https://konakera.sakura.ne.jp/deliverer/delivered/'.$order->order_id, ['class'=>'button is-danger has-text-weight-bold','confirm' => __(' ID：{0} の配達を完了します。よろしいですか?', $order->order_id)]) ?>
                                    </span>
                                </p>           
                            </footer>
                        </div>
